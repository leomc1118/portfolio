    ...
    <Container>
      ...
      <Section delay={0.3}>
        ...
        <Paragraph>
          ...
          employee who keeps everything in their head and, if they left, you
          would not be able to replace them at all. This person is infinitely
          ...
          another person to do the same thing. This person is infinitely
          fireable. Theoretically, the infinitely unfireable engineer is more
          likely to survive a round of layoffs. But when they&apos;re at the
          right company, the company will keep the infinitely fireable employee.
          Coworkers also prefer the infinitely fireable employee, and coworkers
          tend to be the connections that matter more during a time where
          connections have an increasing impact on where you end up.
        </Paragraph>
        <Heading as="h4" variant="section-title">
          II. The Main Thing is to keep the Main Thing the Main Thing
        </Heading>
        <Paragraph>
          The "Main Thing" refers to what made your business/team great in the
          first place. Scope creep and features that don&apos;t serve to make
          the Main Thing better should be politely turned away. A Hunanese
